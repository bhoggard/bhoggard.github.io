...
The hospital’s social workers quickly filed the forms to allow us to start hospice. We met with the intake nurse today, and I spoke to one of the doctors on the phone. The first set of medications arrived today, but we aren’t planning to make changes to his current pain regimen yet.
...
We continue to have regular visitors — 3 today. Our friend Paddy is now coordinating visitors for me. Let me know if I need to make a text or email introduction.
